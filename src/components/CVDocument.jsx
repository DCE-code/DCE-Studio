...
export default function CVDocument({ onBack }) {
  return (
    <div className="cv-document max-w-3xl mx-auto bg-white text-neutral-950 p-8 md:p-12 rounded-2xl shadow-xl font-sans print:shadow-none print:p-0">
      <div className="cv-document__actions">
        <a
          className="cv-document__back-link"
          href="https://dce-studio.vercel.app/"
          onClick={onBack}
        >
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          <div>
            ...
            React, Next.js, JavaScript (ES6+), Python, HTML5, CSS3, Vite,
            Responsive Design
          </div>
          <div>
            <span className="font-semibold text-neutral-900">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            <div className="flex justify-between items-baseline font-semibold">
              <span className="text-neutral-900">
                Interactive Web Applications (Opportunity Hub, Movie Finder,
                Royal Banquet)
              </span>
              <span className="text-xs font-mono text-emerald-600">2026</span>
            </div>
